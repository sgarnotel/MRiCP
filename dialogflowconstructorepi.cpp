...
void DialogFlowConstructorEPI::init_var(){
...
void DialogFlowConstructorEPI::init_win(){
    if (DEBUG) cout << Q_FUNC_INFO << endl;
    ...
    for (int i = 0; i < n_csf; i++){
        ...
        if (file_name.contains(DIALOG_FLOW_CSF_AQUEDUC)){
...
void DialogFlowConstructorEPI::init_sig(){
    if (DEBUG) cout << Q_FUNC_INFO << endl;
...
void DialogFlowConstructorEPI::init_css(){
    if (DEBUG) cout << Q_FUNC_INFO << endl;
...
void DialogFlowConstructorEPI::valid(){
    if (DEBUG) cout << Q_FUNC_INFO << endl;
    ...
    for (int i = 0; i < n_arterial; i++){
        ...
        if (checks_arterial_cerebral[i].isChecked()){
            ...
            if (cerebral_file_name.isEmpty()){
                ...
                cerebral_file_name = cervical_file_name + DIALOG_FLOW_PLUS + list_arterial->at(2*i);
            }
            //Quality
...
void DialogFlowConstructorEPI::cancel(){
    if (DEBUG) cout << Q_FUNC_INFO << endl;
...
void DialogFlowConstructorEPI::delete_all(){
    if (DEBUG) cout << Q_FUNC_INFO << endl;
...
void DialogFlowConstructorEPI::closeEvent(QCloseEvent *){
    if (DEBUG) cout << Q_FUNC_INFO << endl;
