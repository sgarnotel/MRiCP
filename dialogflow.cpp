...
bool DialogFlow::load_flow_data(QString file, int *quality, Coord *data)
{
    ...
    if (fichier.open(QIODevice::ReadOnly)){
        ...
        cout << "ERROR DialogFlow::load_flow_data" << endl;
    #ifndef MAC_OS
...
QStringList DialogFlow::load_flow_informations(QString file_name, bool *res)
{
    if (DEBUG) cout << Q_FUNC_INFO << endl;
...
DialogFlow::DialogFlow(QString dir, QStringList *informations,
    ...
    QDialog(parent)
{
    ...
    if (!res){
        ...
        QMessageBox::critical(this, "ERROR", "BUG FLOW DIR DialogFlow::DialogFlow");
        cancel();
    }
}

void DialogFlow::load(){
    if (DEBUG) cout << Q_FUNC_INFO << endl;
    ...
    //TODO look at Bruker   waiting for Gwenael :)
}

void DialogFlow::set_label_qualitycolor(QLabel *label, int quality)
{
...
void DialogFlow::closeEvent(QCloseEvent *){
